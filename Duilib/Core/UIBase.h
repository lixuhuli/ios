...
#include "animation/AnimationManagerProxy.h"
...
class UILIB_API QRect : public tagRECT
{
public:
    QRect();
    QRect(const RECT& src);
    QRect(int iLeft, int iTop, int iRight, int iBottom);
...
public:
	...
	static HWND GetTopModalWnd(HWND hWnd);
	static UINT ShowModalWnd(HWND hWnd);
