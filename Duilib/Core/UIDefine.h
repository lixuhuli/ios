...
#define DUI_MSGTYPE_CHAR				   (_T("char"))
#define DUI_MSGTYPE_TABCHAR				   (_T("tabchar"))

#define DUI_MSGTYPE_RETURN                 (_T("return"))
#define DUI_MSGTYPE_SCROLL                 (_T("scroll"))

#define DUI_MSGTYPE_FOCUS_IN              (_T("focusin"))
#define DUI_MSGTYPE_FOCUS_OUT             (_T("focusout"))
...
#define DUI_MSGTYPE_WND_SETFOCUS			(_T("wndsetfocus"))
#define	DUI_MSGTYPE_EDIT_RBTNUP				(_T("edit_rbtn_up"))

#define DUI_MSGTYPE_BUTTONSTATECHANGED		(_T("buttonstatechanged"))
#define DUI_MSGTYPE_BEFOREDROPDOWN			(_T("beforedropdown"))
#define DUI_MSGTYPE_ONDESTROYDROPDOWN		(_T("ondestroydropdown"))
//////////////////////////////////////////////////////////////////////////
...
#define  DUI_CTR_ANIMATTABLAYOUT			     (_T("AnimatTabLayout"))
