...
typedef struct tagTListInfoUI
{
    ...
    DWORD dwCheckedTextColor;//当菜单选中时呈现的字体颜色，为菜单添加
...
public:
    ...
    void SetCheckedItemTextColor(DWORD dwCheckTextColor);
    ...
    void LineUp(int nLine = 1);
    void LineDown(int nLine = 1);
    void PageUp();
    void PageDown();
    void HomeUp();
    void EndDown();
