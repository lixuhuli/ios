...
QPoint CRichEditUI::GetCharPos(long lChar) const
{ 
    QPoint pt;
...
QPoint CRichEditUI::PosFromChar(UINT nChar) const
{ 
    POINTL pt; 
...
int CRichEditUI::CharFromPos(QPoint pt) const
{ 
...
void CRichEditUI::SetPos(RECT rc)
{
    ...
    if( m_pVerticalScrollBar != NULL && m_pVerticalScrollBar->IsVisible() ) {
        RECT rcScrollBarPos = { m_rcItem.right - m_pVerticalScrollBar->GetFixedWidth(), m_rcItem.top, m_rcItem.right, rc.bottom};
