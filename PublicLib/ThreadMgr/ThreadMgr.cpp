...
#pragma pack(pop)
	...
	CThread::~CThread()
	{
		...
		{
			CStringA strMsg;
			strMsg.Format("线程 %s 退出超时（5s）,请查看代码！！", this->m_strThreadName.c_str());
#ifdef _DEBUG
			::MessageBoxA(NULL, strMsg, "警告!!!", MB_OK | MB_ICONWARNING);
#endif //_DEBUG
	...
	void CThread::SetThreadName(char* lpszThreadName)
	{
	...
	BOOL CThread::CreateThread(char * lpszThreadName, void * argument)
	{
