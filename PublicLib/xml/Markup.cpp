// Markup.cpp: implementation of the CMarkupEx class.
//
// Markup Release 9.0
// Copyright (C) 1999-2007 First Objective Software, Inc. All rights reserved
// Go to www.firstobject.com for the latest CMarkupEx and EDOM documentation
...
void CMarkupEx::operator=( const CMarkupEx& markup )
{
...
bool CMarkupEx::SetDoc( MCD_PCSZ szDoc )
{
	// Set document text
	if ( szDoc )
		m_strDoc = szDoc;
...
bool CMarkupEx::SetDoc( const MCD_STR& strDoc )
{
	m_strDoc = strDoc;
	MCD_STRCLEAR(m_strError);
	return x_ParseDoc();
...
bool CMarkupEx::Load( MCD_CSTR szFileName )
{
...
bool CMarkupEx::ReadTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
bool CMarkupEx::Save( MCD_CSTR szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nFlags );
}

bool CMarkupEx::WriteTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnFlags )
{
...
bool CMarkupEx::FindElem( MCD_CSTR szName )
{
...
bool CMarkupEx::FindChildElem( MCD_CSTR szName )
{
...
MCD_STR CMarkupEx::EscapeText( MCD_CSTR szText, int nFlags )
{
...
MCD_STR CMarkupEx::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
int CMarkupEx::UTF16To8( char* pszUTF8, const wchar_t* pwszUTF16, int nUTF8Count )
{
...
int CMarkupEx::DecodeCharUTF8( const char*& pszUTF8 )
{
...
void CMarkupEx::EncodeCharUTF16( int nUChar, wchar_t* pwszUTF16, int& nWideLen )
{
...
int CMarkupEx::UTF8To16( wchar_t* pwszUTF16, const char* pszUTF8, int nUTF8Count )
{
...
int CMarkupEx::DecodeCharUTF16( const wchar_t*& pwszUTF16 )
{
...
void CMarkupEx::EncodeCharUTF8( int nUChar, char* pszUTF8, int& nUTF8Len )
{
...
#if ! defined( UNICODE )
MCD_STR CMarkupEx::UTF8ToA( MCD_CSTR pszUTF8, int* pnFailed/*=NULL*/ )
{
...
MCD_STR CMarkupEx::AToUTF8( MCD_CSTR pszANSI )
{
...
MCD_STR CMarkupEx::GetDeclaredEncoding( MCD_CSTR szDoc )
{
...
int CMarkupEx::FindNode( int nType )
{
...
MCD_STR CMarkupEx::GetTagName() const
{
...
MCD_STR CMarkupEx::GetAttribName( int n ) const
{
...
bool CMarkupEx::SavePos( MCD_CSTR szPosName )
{
...
bool CMarkupEx::RestorePos( MCD_CSTR szPosName )
{
...
bool CMarkupEx::RemoveChildElem()
{
...
MCD_STR CMarkupEx::x_GetLastError()
{
	MCD_STR strError;
#ifdef MCD_STRERROR
...
bool CMarkupEx::x_AllocPosArray( int nNewSize /*=0*/ )
{
...
int CMarkupEx::x_ParseElem( int iPosParent, TokenPos& token )
{
...
bool CMarkupEx::x_FindAny( MCD_PCSZ szDoc, int& nChar )
{
...
bool CMarkupEx::x_FindName( CMarkupEx::TokenPos& token )
{
...
MCD_STR CMarkupEx::x_GetToken( const CMarkupEx::TokenPos& token )
{
...
int CMarkupEx::x_FindElem( int iPosParent, int iPos, MCD_PCSZ szPath ) const
{
...
int CMarkupEx::x_ParseNode( CMarkupEx::TokenPos& token, CMarkupEx::NodePos& node )
{
...
MCD_STR CMarkupEx::x_GetPath( int iPos ) const
{
	MCD_STR strPath;
	while ( iPos )
	{
...
MCD_STR CMarkupEx::x_GetTagName( int iPos ) const
{
...
bool CMarkupEx::x_FindAttrib( CMarkupEx::TokenPos& token, MCD_PCSZ szAttrib, int n/*=0*/ )
{
...
MCD_STR CMarkupEx::x_GetAttrib( int iPos, MCD_PCSZ szAttrib ) const
{
...
bool CMarkupEx::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, int nValue )
{
...
bool CMarkupEx::x_SetAttrib( int iPos, MCD_PCSZ szAttrib, MCD_PCSZ szValue )
{
...
bool CMarkupEx::x_CreateNode( MCD_STR& strNode, int nNodeType, MCD_PCSZ szText )
{
...
MCD_STR CMarkupEx::x_EncodeCDATASection( MCD_PCSZ szData )
{
...
bool CMarkupEx::x_SetData( int iPos, int nValue )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
bool CMarkupEx::x_SetData( int iPos, MCD_PCSZ szData, int nFlags )
{
...
MCD_STR CMarkupEx::x_GetData( int iPos ) const
{
	if ( iPos == m_iPos && m_nNodeLength )
	{
...
MCD_STR CMarkupEx::x_GetElemContent( int iPos ) const
{
...
bool CMarkupEx::x_SetElemContent( MCD_PCSZ szContent )
{
...
void CMarkupEx::x_DocChange( int nLeft, int nReplace, const MCD_STR& strInsert )
{
...
void CMarkupEx::x_Adjust( int iPos, int nShift, bool bAfterPos /*=false*/ )
{
...
int CMarkupEx::x_InsertNew( int iPosParent, int& iPosRel, CMarkupEx::NodePos& node )
{
...
bool CMarkupEx::x_AddElem( MCD_PCSZ szName, int nValue, int nFlags )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( szVal, _T("%d"), nValue );
...
bool CMarkupEx::x_AddElem( MCD_PCSZ szName, MCD_PCSZ szValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
MCD_STR CMarkupEx::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
bool CMarkupEx::x_AddSubDoc( MCD_PCSZ szSubDoc, int nFlags )
{
...
int CMarkupEx::x_RemoveElem( int iPos )
{
...
void CMarkupEx::x_LinkElem( int iPosParent, int iPosBefore, int iPos )
{
...
int CMarkupEx::x_UnlinkElem( int iPos )
{
...
int CMarkupEx::x_ReleasePos( int iPos )
{
...
int CMarkupEx::x_ReleaseSubDoc( int iPos )
{
...
void CMarkupEx::x_CheckSavedPos()
{
...
void CMarkupEx::x_AdjustForNode( int iPosParent, int iPos, int nShift )
{
...
bool CMarkupEx::x_AddNode( int nNodeType, MCD_PCSZ szText, int nFlags )
{
...
void CMarkupEx::x_RemoveNode( int iPosParent, int& iPos, int& nNodeType, int& nNodeOffset, int& nNodeLength )
{
