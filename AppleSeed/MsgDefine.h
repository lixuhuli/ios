...
enum{
    ...
    WM_MAINWND_MSG_SHOW_POPWND,

    WM_MAINWND_MSG_SHOW_PEROPTIMIZATION_WARNING,

    WM_MAINWND_MSG_START_WAITING_ANIMATION,
...
enum{
    ...
    WM_KEYWND_MSG_CREATE_ITEM,
    WM_KEYWND_MSG_SELECT_ITEM,
    WM_KEYWND_MSG_REMOVE_ITEM,
